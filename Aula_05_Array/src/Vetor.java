...
public class Vetor {
	...
	public static void main(String[] args) {
		...
		for (int contador = 0; contador < vetorReais.length; contador++) {
			System.out.printf("Digite um valor Real para posição %d: \n", contador);
		...
		// Para listar de traz pra frente (lista em ordem decrescente e não muda a ordem do vetor)>>
		...
		// Lista o indice com o numero 10
